...
- Ensure we expose all options in the Webpack plugin that are available in the Bugsnag CLI (#98)
- Allow BugsnagBuildReporterPlugin to pass all options in a single object (#98)
